...
ZianTT.utils = {
  ...
  waitElementVisible: function(selectorOrElement, callback, offsetFactor) {
    ...
    function waitInViewport(element) {
      if (ZianTT.utils.elementVisible(element, offsetFactor)) {
        callback();
        return;
      }
      if ('IntersectionObserver' in window) {
        ...
        var wrapper = ZianTT.utils.listenScroll(function() {
          if (ZianTT.utils.elementVisible(element, offsetFactor)) {
            ZianTT.utils.unlistenScroll(wrapper);
            callback();
          }
        });
      }
  ...
  loadComments: function(selector, loadFunc) {
    ...
    if (ele) {
      ...
      ZianTT.utils.waitElementVisible(selector, callback, CONFIG.lazyload.offset_factor);
    } else {
      loadFunc();
    }
  },
