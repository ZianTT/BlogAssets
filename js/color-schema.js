...
(function(window, document) {
  ...
  var colorSchemaStorageKey = 'ZianTT_Color_Scheme';
  ...
  function setButtonIcon(schema) {
    if (validColorSchemaKeys[schema]) {
      ...
      if (iconElement) {
        ...
        ZianTT.utils.waitElementLoaded(colorToggleIconSelector, function() {
          var iconElement = document.querySelector(colorToggleIconSelector);
          if (iconElement) {
            iconElement.setAttribute(
              'class',
  ...
  function setHighlightCSS(schema) {
    ...
    setTimeout(function() {
      ...
      document.querySelectorAll('.markdown-body pre').forEach((pre) => {
        var cls = ZianTT.utils.getBackgroundLightness(pre) >= 0 ? 'code-widget-light' : 'code-widget-dark';
